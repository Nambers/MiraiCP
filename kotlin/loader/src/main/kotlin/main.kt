...
//        exitProcess(0)
    ...
    fun main(j: String, path: String) {
        ...
        PublicSharedData.logger.info("⭐MiraiCP-plugin 版本: ${PublicShared.now_tag}, 构建时间: ${BuiltInConstants.date}, mirai版本: ${BuiltInConstants.miraiVersion}")
