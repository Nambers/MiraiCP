...
object CPPLibMultiplatform {
    fun init(
        ...
        if (libPath == null) {
            ...
            System.load(UlitsMultiPlatform.getLibLoader(libPath))
        }
    ...
    @Suppress("unused")
    @JvmStatic
    fun KSendLog(log: String, level: Int) = CPPLib.sendLog(log, level)

    @Suppress("unused")
    @JvmStatic
    fun KOperation(content: String): String = CPPLib.operation(content)
